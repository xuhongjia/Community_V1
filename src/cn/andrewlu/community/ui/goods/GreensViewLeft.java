...
public class GreensViewLeft extends LinearLayout implements ViewBaseAction {
	...
	private GreensAdapter plateListViewAdapter;
	private GreensAdapter earaListViewAdapter;
	private OnSelectListener mOnSelectListener;
	private int tEaraPosition = 0;
	private int tBlockPosition = 0;
	private String showString = "不限";

	public GreensViewLeft(Context context) {
		super(context);
		init(context);
	}

	public GreensViewLeft(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
	...
	private void init(Context context) {
		...
		earaListViewAdapter = new GreensAdapter(context, groups,
		...
		earaListViewAdapter
				.setOnItemClickListener(new GreensAdapter.OnItemClickListener() {
		...
		if (tEaraPosition < children.size())
			childrenItem.addAll(children.get(6));
		plateListViewAdapter = new GreensAdapter(context, childrenItem,
