...
public class ActivityPet extends Activity {
	...
	private void initListener() {
		...
		viewLeft.setOnSelectListener(new PetViewLeft.OnSelectListener() {
	...
	private void onRefresh(View view, String showText) {
		...
		Toast.makeText(ActivityPet.this, showText, Toast.LENGTH_SHORT).show();
