...
public class ActivityDay extends Activity {
	...
	@ViewInject(value= R.id.day_back)
	private View day_back;

	private ExpandTabView expandTabView;
	private ArrayList<View> mViewArray = new ArrayList<View>();
	private ViewMiddle viewMiddle;
	private DayViewLeft viewLeft;
	...
	private void initListener() {
		...
		viewLeft.setOnSelectListener(new DayViewLeft.OnSelectListener() {
	...
	private void onRefresh(View view, String showText) {
		...
		Toast.makeText(ActivityDay.this, showText, Toast.LENGTH_SHORT).show();
