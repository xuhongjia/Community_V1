...
public class RentViewLeft extends LinearLayout implements ViewBaseAction {
	...
	private RentAdapter plateListViewAdapter;
	private RentAdapter earaListViewAdapter;
	private OnSelectListener mOnSelectListener;
	private int tEaraPosition = 0;
	private int tBlockPosition = 0;
	private String showString = "不限";

	public RentViewLeft(Context context) {
		super(context);
		init(context);
	}

	public RentViewLeft(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
	...
	private void init(Context context) {
		...
		earaListViewAdapter = new RentAdapter(context, groups,
		...
		earaListViewAdapter
				.setOnItemClickListener(new RentAdapter.OnItemClickListener() {
		...
		if (tEaraPosition < children.size())
			childrenItem.addAll(children.get(4));
		plateListViewAdapter = new RentAdapter(context, childrenItem,
