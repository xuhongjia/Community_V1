...
public class RentAdapter extends ArrayAdapter<String> {
	...
	public RentAdapter(Context context, List<String> listData, int sId, int nId) {
	...
	public RentAdapter(Context context, String[] arrayData, int sId, int nId) {
