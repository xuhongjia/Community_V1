...
public class FurnitureViewLeft extends LinearLayout implements ViewBaseAction {
	...
	private FurnitureAdapter plateListViewAdapter;
	private FurnitureAdapter earaListViewAdapter;
	private OnSelectListener mOnSelectListener;
	private int tEaraPosition = 0;
	private int tBlockPosition = 0;
	private String showString = "不限";

	public FurnitureViewLeft(Context context) {
		super(context);
		init(context);
	}

	public FurnitureViewLeft(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
	...
	private void init(Context context) {
		...
		earaListViewAdapter = new FurnitureAdapter(context, groups,
		...
		earaListViewAdapter
				.setOnItemClickListener(new FurnitureAdapter.OnItemClickListener() {
		...
		if (tEaraPosition < children.size())
			childrenItem.addAll(children.get(1));
		plateListViewAdapter = new FurnitureAdapter(context, childrenItem,
