...
public class EletronicViewLeft extends LinearLayout implements ViewBaseAction {
	...
	private EletronicAdapter plateListViewAdapter;
	private EletronicAdapter earaListViewAdapter;
	private OnSelectListener mOnSelectListener;
	private int tEaraPosition = 0;
	private int tBlockPosition = 0;
	private String showString = "不限";

	public EletronicViewLeft(Context context) {
		super(context);
		init(context);
	}

	public EletronicViewLeft(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
	...
	private void init(Context context) {
		...
		earaListViewAdapter = new EletronicAdapter(context, groups,
		...
		earaListViewAdapter
				.setOnItemClickListener(new EletronicAdapter.OnItemClickListener() {
		...
		if (tEaraPosition < children.size())
			childrenItem.addAll(children.get(2));
		plateListViewAdapter = new EletronicAdapter(context, childrenItem,
