...
public class DayAdapter extends ArrayAdapter<String> {
	...
	public DayAdapter(Context context, List<String> listData, int sId, int nId) {
	...
	public DayAdapter(Context context, String[] arrayData, int sId, int nId) {
