...
public class FurnitureAdapter extends ArrayAdapter<String> {
	...
	public FurnitureAdapter(Context context, List<String> listData, int sId, int nId) {
	...
	public FurnitureAdapter(Context context, String[] arrayData, int sId, int nId) {
