...
public class EletronicAdapter extends ArrayAdapter<String> {
	...
	public EletronicAdapter(Context context, List<String> listData, int sId, int nId) {
	...
	public EletronicAdapter(Context context, String[] arrayData, int sId, int nId) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		TextView view;
		if (convertView == null) {
			view = (TextView) LayoutInflater.from(mContext).inflate(R.layout.secondhand_choose_item, parent, false);
		} else {
