...
public class ExpandTabView extends LinearLayout implements OnDismissListener {
	...
	public void setValue(ArrayList<String> textArray, ArrayList<View> viewArray) {
		...
		for (int i = 0; i < viewArray.size(); i++) {
			...
			mViewArray.add(r);
			r.setTag(SMALL);
			ToggleButton tButton = (ToggleButton) inflater.inflate(R.layout.secondhand_toggle_button, this, false);
			addView(tButton);
			View line = (View) inflater.inflate(R.layout.secondhand_choosebar_line, this, false);
