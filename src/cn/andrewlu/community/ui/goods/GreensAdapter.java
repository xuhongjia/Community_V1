...
public class GreensAdapter extends ArrayAdapter<String> {
	...
	public GreensAdapter(Context context, List<String> listData, int sId, int nId) {
	...
	public GreensAdapter(Context context, String[] arrayData, int sId, int nId) {
