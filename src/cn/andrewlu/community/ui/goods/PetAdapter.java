...
public class PetAdapter extends ArrayAdapter<String> {
	...
	public PetAdapter(Context context, List<String> listData, int sId, int nId) {
	...
	public PetAdapter(Context context, String[] arrayData, int sId, int nId) {
