...
public class DayViewLeft extends LinearLayout implements ViewBaseAction {
	...
	private DayAdapter plateListViewAdapter;
	private DayAdapter earaListViewAdapter;
	private OnSelectListener mOnSelectListener;
	private int tEaraPosition = 0;
	private int tBlockPosition = 0;
	private String showString = "不限";

	public DayViewLeft(Context context) {
		super(context);
		init(context);
	}

	public DayViewLeft(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
	...
	private void init(Context context) {
		...
		earaListViewAdapter = new DayAdapter(context, groups,
		...
		earaListViewAdapter
				.setOnItemClickListener(new DayAdapter.OnItemClickListener() {
		...
		if (tEaraPosition < children.size())
			childrenItem.addAll(children.get(5));
		plateListViewAdapter = new DayAdapter(context, childrenItem,
