...
public class ActivitySecondhand extends Activity {
	
	@ViewInject(value= R.id.secondhand_back)
	private View secondhand_back;
	...
	private void onRefresh(View view, String showText) {
		...
		Toast.makeText(ActivitySecondhand.this, showText, Toast.LENGTH_SHORT).show();
	...
	@OnClick({R.id.secondhand_back})
	public void onClick(View view) {
		switch (view.getId()) {
		case R.id.secondhand_back: {
			finish();
			break;
		}
	  }
