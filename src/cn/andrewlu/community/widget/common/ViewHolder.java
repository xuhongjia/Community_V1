...
import cn.andrewlu.community.widget.common.ImageLoader.Type;
...
public class ViewHolder {
     ...
     * @return
     */
    public ViewHolder setImageByView(int viewId, String url) {
    	ImageView imageView=(ImageView)mConvertView.findViewById(viewId);
        if (url == null || url.length() <= 0) {
            return this;
        }
        BitMaoUtils.downLoadImage((ImageView)mConvertView.findViewById(viewId),url);
        return this;
    }
